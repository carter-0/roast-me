        ...
        <>
            ...
            <Layout>
                <main className={"flex flex-col items-center"}>
                    ...
                    <div className={"flex flex-col items-center text-center mt-5 mx-5 sm:mx-0 sm:max-w-[620px]"}>
                        ...
                        <h3 className={"text-sm mt-2 leading-[1.4rem] md:leading-[1.8rem] md:text-lg font-normal text-gray-600"}>Get 20+ savage roasts generated by our unrelenting AI-roaster. Upload your photo & receive your roasts within 30 seconds.</h3>
